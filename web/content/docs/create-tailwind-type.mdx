---
title: CLI create-tailwind-type
...
If you are using tailwindcss >= 4.0, then it will correctly create type-def based on your tailwind version.

But if you are not using tailwind v4, then it will create latest version of tailwind type-set.
</Callout>
---

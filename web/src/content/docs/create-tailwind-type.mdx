...
`create-tailwind-type` is a CLI tool that generates TypeScript definitions from your `tailwind.config.js` file. This allows you to use all of your project's Tailwind CSS classes and variants with full type-safety.

...
export interface ShortTailwindestAria<
    Nest extends string,
    Tailwind,
...
export type ShortTailwindestAriaCustom<
    Nest extends string,
    Tailwind,
...
interface ShortTailwindestPeer<Nest extends string, Tailwind> {
    /**
...
export interface ShortTailwindestNestExtends<Nest extends string, ShortTailwind>
    extends ShortTailwindestGroup<Nest, ShortTailwind>,
        ShortTailwindestPeer<Nest, ShortTailwind> {}

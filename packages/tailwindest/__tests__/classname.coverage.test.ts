...
import TailwindTypes from "./TailwindTypes.out"

type BasicTailwindest = Omit<Tailwindest, never>
...
const ClassMap = {
    ...
    boxDecoration: ["box-decoration-clone", "box-decoration-slice"],
    ...
    visibility: ["collapse", "invisible", "visible"],
    zIndex: [
        "z-0",
        "z-10",
        "z-20",
    ...
    flex: ["flex-1", "flex-[2_2_0%]", "flex-auto", "flex-initial", "flex-none"],
    flexGrow: ["grow", "grow-0", "grow-[2]"],
    flexShrink: ["shrink", "shrink-0", "shrink-[2]"],
    order: [
        "order-1",
        "order-10",
        "order-11",
    ...
    fontFamily: ["font-['Open_Sans']", "font-mono", "font-sans", "font-serif"],
    fontSize: [
        "text-2xl",
        "text-3xl",
        "text-4xl",
    ...
    listStyleImage: ["list-image-[url(checkmark.png)]", "list-image-none"],
    ...
    textOverflow: ["text-clip", "text-ellipsis", "truncate"],
    textWrap: ["text-balance", "text-nowrap", "text-pretty", "text-wrap"],
    textIndent: [
        "indent-0",
        "indent-0.5",
        "indent-1",
    ...
    wordBreak: ["break-all", "break-keep", "break-normal", "break-words"],
    hyphens: ["hyphens-auto", "hyphens-manual", "hyphens-none"],
    content: ["before:content-['Hello_World']", "content-none"],
    ...
    filterGrayscale: ["grayscale", "grayscale-0", "grayscale-[50%]"],
    filterHueRotate: [
        "hue-rotate-0",
        "hue-rotate-15",
        "hue-rotate-180",
    ...
    filterInvert: ["invert", "invert-0", "invert-[.25]"],
    filterSaturate: [
        "saturate-0",
        "saturate-100",
        "saturate-150",
    ...
    filterSepia: ["sepia", "sepia-0", "sepia-[.25]"],
    backdropBlur: [
        "backdrop-blur",
        "backdrop-blur-2xl",
        "backdrop-blur-3xl",
    ...
    captionSide: ["caption-bottom", "caption-top"],
    transitionProperty: [
        "transition",
        "transition-[height]",
        "transition-all",
    ...
    appearance: ["appearance-auto", "appearance-none"],
    cursor: [
    ...
    scrollSnapStop: ["snap-always", "snap-normal"],
    scrollSnapType: [
        "snap-both",
        "snap-mandatory",
        "snap-none",
    ...
    userSelect: ["select-all", "select-auto", "select-none", "select-text"],
    willChange: [
    ...
    strokeWidth: ["stroke-0", "stroke-1", "stroke-2", "stroke-[2px]"],
    screenReaders: ["not-sr-only", "sr-only"],
    forcedColorAdjust: ["forced-color-adjust-auto", "forced-color-adjust-none"],
} as const satisfies Record<string, never> & {
    [key in keyof BasicTailwindest]: BasicTailwindest[key][]
}
...
describe(label.unit("Basic tailwind classname coverage"), () => {
    test("check all classnames used", () => {
        // used to see missing classes (never if there are no missing classes)
        type Missing = Exclude<TailwindTypes, ClassMapTypes>
        const missing: Missing[] = []
        expect(missing).toBe([])

        // used to see extra classes (never if there are no extra classes)
        type Extra = Exclude<ClassMapTypes, TailwindTypes>
        const extra: Extra[] = []
        expect(extra).toBe([])

        // this line will be an error if there are missing / extra props
        // use above types to find extras;
        const valid: TypesSimilar<TailwindTypes, ClassMapTypes> = true

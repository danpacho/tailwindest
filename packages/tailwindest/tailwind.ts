...
type AnimationRef1 = "0" | "1" | "2" | "3" | "6" | "12" | "45" | "90" | "180"
type AnimationRef2 = "0" | "25" | "50" | "75" | "100" | "150"
type AnimationRef3 = TailwindGlobalColor
type AnimationRef4 = "0" | "2xl" | "3xl" | "lg" | "md" | "sm" | "xl" | "xs"
type AnimationRef5 = "in" | "in-0" | "out" | "out-0"
type AnimationRef6 =
    | "0"
    | "5"
    | "10"
    ...
    | "95"
    | "100"
type AnimationRef7 = "lg" | "md" | "sm"
type AnimationRef8 = "lg" | "md" | "sm"
type AnimationRef9 = "lg" | "md" | "sm"
type AnimationRef10 = "lg" | "md" | "sm"
type AnimationRef11 = "lg" | "md" | "sm"
type AnimationRef12 = "down" | "left" | "right" | "up"
type AnimationRef13 = "lg" | "md" | "sm"
type AnimationRef14 =
    | "left"
    | "left-lg"
    | "left-md"
    ...
    | "right-sm"
    | "sm"
type AnimationRef15 = "lg" | "md" | "sm"
type AnimationRef16 = "lg" | "md" | "sm"
type AnimationRef17 = "lg" | "md" | "sm"
type AnimationRef18 = "lg" | "md" | "sm"
type AnimationRef19 =
    | "0"
    | "50"
    | "75"
...
type AnimationRef21 =
    ...
    | "spin"
    | "spin-ping"
type AnimationRef22 = "in" | "out"
type AnimationRef23 = "in" | "out"
type AnimationRef24 = "down" | "left" | "right" | "up"
type AnimationRef25 = "in" | "out"
type AnimationRef26 = "in" | "out"
type AnimationRef27 = "in" | "out"
type AnimationRef28 =
    | "blink"
    | "blur-down"
    | "blur-down-lg"
...
type CustomRef1 =
    ...
    | "loop-90"
    | "loop-180"
type CustomRef2 = "loop"
type CustomRef3 = "0" | "25" | "50" | "75" | "100" | "150"
type CustomRef4 = "loop"
type CustomRef5 =
    | "loop"
    | "loop-0"
    | "loop-2xl"
...
type CustomRef7 =
    ...
    | "quad"
    | "quart"
type CustomRef8 = "back" | "cubic" | "quad" | "quart"
type CustomRef9 = "bouncier" | "bounciest" | "bouncy" | "smooth" | "snappy"
type CustomRef10 = "infinite" | "once" | "twice"
type CustomRef11 =
    | "loop"
    | "loop-0"
    | "loop-5"
...
type CustomRef16 =
    ...
    | "yellow"
    | "zinc"
type CustomRef17 = TailwindGlobalColor
type CustomRef18 = "bounce" | "in" | "linear" | "out"
type CustomRef19 =
    | "delay"
    | "duration"
    | "ease"
...
type FontWeightRef1 =
    ...
    | "semibold"
    | "thin"
type FontFamilyRef1 = "mono" | "nanum" | "platypi" | "sans" | "serif"
...
type AnimationMotionrotateinLiteral = `motion-rotate-in-${AnimationRef1}`
type AnimationMotionrotateinLiteralWithSign =
    | AnimationMotionrotateinLiteral
    | `-${AnimationMotionrotateinLiteral}`
type AnimationMotionrotateoutLiteral = `motion-rotate-out-${AnimationRef1}`
type AnimationMotionrotateoutLiteralWithSign =
    | AnimationMotionrotateoutLiteral
    | `-${AnimationMotionrotateoutLiteral}`
type AnimationMotiontranslatexinLiteral =
    `motion-translate-x-in-${AnimationRef2}`
type AnimationMotiontranslatexinLiteralWithSign =
    | AnimationMotiontranslatexinLiteral
    | `-${AnimationMotiontranslatexinLiteral}`
type AnimationMotiontranslatexoutLiteral =
    `motion-translate-x-out-${AnimationRef2}`
type AnimationMotiontranslatexoutLiteralWithSign =
    | AnimationMotiontranslatexoutLiteral
    | `-${AnimationMotiontranslatexoutLiteral}`
type AnimationMotiontranslateyinLiteral =
    `motion-translate-y-in-${AnimationRef2}`
type AnimationMotiontranslateyinLiteralWithSign =
    | AnimationMotiontranslateyinLiteral
    | `-${AnimationMotiontranslateyinLiteral}`
type AnimationMotiontranslateyoutLiteral =
    `motion-translate-y-out-${AnimationRef2}`
type AnimationMotiontranslateyoutLiteralWithSign =
    | AnimationMotiontranslateyoutLiteral
    | `-${AnimationMotiontranslateyoutLiteral}`
type AnimationMotionbginLiteral = `motion-bg-in-${AnimationRef3}`
type AnimationMotionbginLiteralWithSign =
    | AnimationMotionbginLiteral
    | `-${AnimationMotionbginLiteral}`
type AnimationMotionbgloopLiteral = `motion-bg-loop-${AnimationRef3}`
type AnimationMotionbgloopLiteralWithSign =
    | AnimationMotionbgloopLiteral
    | `-${AnimationMotionbgloopLiteral}`
type AnimationMotionbgoutLiteral = `motion-bg-out-${AnimationRef3}`
type AnimationMotionbgoutLiteralWithSign =
    | AnimationMotionbgoutLiteral
    | `-${AnimationMotionbgoutLiteral}`
type AnimationMotionblurinLiteral = `motion-blur-in-${AnimationRef4}`
type AnimationMotionblurinLiteralWithSign =
    | AnimationMotionblurinLiteral
    | `-${AnimationMotionblurinLiteral}`
type AnimationMotionbluroutLiteral = `motion-blur-out-${AnimationRef4}`
type AnimationMotionbluroutLiteralWithSign =
    | AnimationMotionbluroutLiteral
    | `-${AnimationMotionbluroutLiteral}`
type AnimationMotiongrayscaleLiteral = `motion-grayscale-${AnimationRef5}`
type AnimationMotiongrayscaleLiteralWithSign =
    | AnimationMotiongrayscaleLiteral
    | `-${AnimationMotiongrayscaleLiteral}`
type AnimationMotionopacityinLiteral = `motion-opacity-in-${AnimationRef6}`
type AnimationMotionopacityinLiteralWithSign =
    | AnimationMotionopacityinLiteral
    | `-${AnimationMotionopacityinLiteral}`
type AnimationMotionopacityoutLiteral = `motion-opacity-out-${AnimationRef6}`
type AnimationMotionopacityoutLiteralWithSign =
    | AnimationMotionopacityoutLiteral
    | `-${AnimationMotionopacityoutLiteral}`
type AnimationMotionpresetfadeLiteral = `motion-preset-fade-${AnimationRef7}`
type AnimationMotionpresetfadeLiteralWithSign =
    | AnimationMotionpresetfadeLiteral
    | `-${AnimationMotionpresetfadeLiteral}`
type AnimationMotionpresetfloatLiteral = `motion-preset-float-${AnimationRef8}`
type AnimationMotionpresetfloatLiteralWithSign =
    | AnimationMotionpresetfloatLiteral
    | `-${AnimationMotionpresetfloatLiteral}`
type AnimationMotionpresetfocusLiteral = `motion-preset-focus-${AnimationRef9}`
type AnimationMotionpresetfocusLiteralWithSign =
    | AnimationMotionpresetfocusLiteral
    | `-${AnimationMotionpresetfocusLiteral}`
type AnimationMotionpresetoscillateLiteral =
    `motion-preset-oscillate-${AnimationRef10}`
type AnimationMotionpresetoscillateLiteralWithSign =
    | AnimationMotionpresetoscillateLiteral
    | `-${AnimationMotionpresetoscillateLiteral}`
type AnimationMotionpresetpulseLiteral = `motion-preset-pulse-${AnimationRef11}`
type AnimationMotionpresetpulseLiteralWithSign =
    | AnimationMotionpresetpulseLiteral
    | `-${AnimationMotionpresetpulseLiteral}`
type AnimationMotionpresetreboundLiteral =
    `motion-preset-rebound-${AnimationRef12}`
type AnimationMotionpresetreboundLiteralWithSign =
    | AnimationMotionpresetreboundLiteral
    | `-${AnimationMotionpresetreboundLiteral}`
type AnimationMotionpresetseesawLiteral =
    `motion-preset-seesaw-${AnimationRef13}`
type AnimationMotionpresetseesawLiteralWithSign =
    | AnimationMotionpresetseesawLiteral
    | `-${AnimationMotionpresetseesawLiteral}`
type AnimationMotionpresetslidedownLiteral =
    `motion-preset-slide-down-${AnimationRef14}`
type AnimationMotionpresetslidedownLiteralWithSign =
    | AnimationMotionpresetslidedownLiteral
    | `-${AnimationMotionpresetslidedownLiteral}`
type AnimationMotionpresetslideleftLiteral =
    `motion-preset-slide-left-${AnimationRef15}`
type AnimationMotionpresetslideleftLiteralWithSign =
    | AnimationMotionpresetslideleftLiteral
    | `-${AnimationMotionpresetslideleftLiteral}`
type AnimationMotionpresetsliderightLiteral =
    `motion-preset-slide-right-${AnimationRef16}`
type AnimationMotionpresetsliderightLiteralWithSign =
    | AnimationMotionpresetsliderightLiteral
    | `-${AnimationMotionpresetsliderightLiteral}`
type AnimationMotionpresetslideupLiteral =
    `motion-preset-slide-up-${AnimationRef14}`
type AnimationMotionpresetslideupLiteralWithSign =
    | AnimationMotionpresetslideupLiteral
    | `-${AnimationMotionpresetslideupLiteral}`
type AnimationMotionpresetstretchLiteral =
    `motion-preset-stretch-${AnimationRef17}`
type AnimationMotionpresetstretchLiteralWithSign =
    | AnimationMotionpresetstretchLiteral
    | `-${AnimationMotionpresetstretchLiteral}`
type AnimationMotionpresetwobbleLiteral =
    `motion-preset-wobble-${AnimationRef18}`
type AnimationMotionpresetwobbleLiteralWithSign =
    | AnimationMotionpresetwobbleLiteral
    | `-${AnimationMotionpresetwobbleLiteral}`
type AnimationMotionscaleinLiteral = `motion-scale-in-${AnimationRef19}`
type AnimationMotionscaleinLiteralWithSign =
    | AnimationMotionscaleinLiteral
    | `-${AnimationMotionscaleinLiteral}`
type AnimationMotionscaleoutLiteral = `motion-scale-out-${AnimationRef19}`
type AnimationMotionscaleoutLiteralWithSign =
    | AnimationMotionscaleoutLiteral
    | `-${AnimationMotionscaleoutLiteral}`
type AnimationMotionscalexLiteral = `motion-scale-x-${AnimationRef20}`
type AnimationMotionscalexLiteralWithSign =
    | AnimationMotionscalexLiteral
    | `-${AnimationMotionscalexLiteral}`
type AnimationMotionscaleyLiteral = `motion-scale-y-${AnimationRef20}`
type AnimationMotionscaleyLiteralWithSign =
    | AnimationMotionscaleyLiteral
    | `-${AnimationMotionscaleyLiteral}`
type AnimationMotiontextinLiteral = `motion-text-in-${AnimationRef3}`
type AnimationMotiontextinLiteralWithSign =
    | AnimationMotiontextinLiteral
    | `-${AnimationMotiontextinLiteral}`
type AnimationMotiontextoutLiteral = `motion-text-out-${AnimationRef3}`
type AnimationMotiontextoutLiteralWithSign =
    | AnimationMotiontextoutLiteral
    | `-${AnimationMotiontextoutLiteral}`
type AnimationAnimateLiteral = `animate-${AnimationRef21}`
type AnimationAnimateLiteralWithSign =
    | AnimationAnimateLiteral
    | `-${AnimationAnimateLiteral}`
type AnimationMotionblurLiteral = `motion-blur-${AnimationRef22}`
type AnimationMotionblurLiteralWithSign =
    | AnimationMotionblurLiteral
    | `-${AnimationMotionblurLiteral}`
type AnimationMotiontranslatexLiteral = `motion-translate-x-${AnimationRef23}`
type AnimationMotiontranslatexLiteralWithSign =
    | AnimationMotiontranslatexLiteral
    | `-${AnimationMotiontranslatexLiteral}`
type AnimationMotionpresetslideLiteral = `motion-preset-slide-${AnimationRef24}`
type AnimationMotionpresetslideLiteralWithSign =
    | AnimationMotionpresetslideLiteral
    | `-${AnimationMotionpresetslideLiteral}`
type AnimationMotionrotateLiteral = `motion-rotate-${AnimationRef25}`
type AnimationMotionrotateLiteralWithSign =
    | AnimationMotionrotateLiteral
    | `-${AnimationMotionrotateLiteral}`
type AnimationMotionopacityLiteral = `motion-opacity-${AnimationRef26}`
type AnimationMotionopacityLiteralWithSign =
    | AnimationMotionopacityLiteral
    | `-${AnimationMotionopacityLiteral}`
type AnimationMotionscaleLiteral = `motion-scale-${AnimationRef27}`
type AnimationMotionscaleLiteralWithSign =
    | AnimationMotionscaleLiteral
    | `-${AnimationMotionscaleLiteral}`
type AnimationMotionpresetLiteral = `motion-preset-${AnimationRef28}`
type AnimationMotionpresetLiteralWithSign =
    | AnimationMotionpresetLiteral
    | `-${AnimationMotionpresetLiteral}`
type AnimationMotiontranslateyLiteral = `motion-translate-y-${AnimationRef29}`
type AnimationMotiontranslateyLiteralWithSign =
    | AnimationMotiontranslateyLiteral
    | `-${AnimationMotiontranslateyLiteral}`
type AnimationValue =
    | AnimationMotionrotateinLiteralWithSign
    | AnimationMotionrotateoutLiteralWithSign
    | AnimationMotiontranslatexinLiteralWithSign
    | AnimationMotiontranslatexoutLiteralWithSign
    | AnimationMotiontranslateyinLiteralWithSign
    | AnimationMotiontranslateyoutLiteralWithSign
    | AnimationMotionbginLiteralWithSign
    | AnimationMotionbgloopLiteralWithSign
    | AnimationMotionbgoutLiteralWithSign
    | AnimationMotionblurinLiteralWithSign
    | AnimationMotionbluroutLiteralWithSign
    | AnimationMotiongrayscaleLiteralWithSign
    | AnimationMotionopacityinLiteralWithSign
    | AnimationMotionopacityoutLiteralWithSign
    | AnimationMotionpresetfadeLiteralWithSign
    | AnimationMotionpresetfloatLiteralWithSign
    | AnimationMotionpresetfocusLiteralWithSign
    | AnimationMotionpresetoscillateLiteralWithSign
    | AnimationMotionpresetpulseLiteralWithSign
    | AnimationMotionpresetreboundLiteralWithSign
    | AnimationMotionpresetseesawLiteralWithSign
    | AnimationMotionpresetslidedownLiteralWithSign
    | AnimationMotionpresetslideleftLiteralWithSign
    | AnimationMotionpresetsliderightLiteralWithSign
    | AnimationMotionpresetslideupLiteralWithSign
    | AnimationMotionpresetstretchLiteralWithSign
    | AnimationMotionpresetwobbleLiteralWithSign
    | AnimationMotionscaleinLiteralWithSign
    | AnimationMotionscaleoutLiteralWithSign
    | AnimationMotionscalexLiteralWithSign
    | AnimationMotionscaleyLiteralWithSign
    | AnimationMotiontextinLiteralWithSign
    | AnimationMotiontextoutLiteralWithSign
    | AnimationAnimateLiteralWithSign
    | AnimationMotionblurLiteralWithSign
    | AnimationMotiontranslatexLiteralWithSign
    | AnimationMotionpresetslideLiteralWithSign
    | AnimationMotionrotateLiteralWithSign
    | AnimationMotionopacityLiteralWithSign
    | AnimationMotionscaleLiteralWithSign
    | AnimationMotionpresetLiteralWithSign
    | AnimationMotiontranslateyLiteralWithSign
...
type CustomMotionrotateLiteral = `motion-rotate-${CustomRef1}`
type CustomMotionrotateLiteralWithSign =
    | CustomMotionrotateLiteral
    | `-${CustomMotionrotateLiteral}`
type CustomMotiontranslatexLiteral = `motion-translate-x-${CustomRef2}`
type CustomMotiontranslatexLiteralWithSign =
    | CustomMotiontranslatexLiteral
    | `-${CustomMotiontranslatexLiteral}`
type CustomMotiontranslatexloopLiteral = `motion-translate-x-loop-${CustomRef3}`
type CustomMotiontranslatexloopLiteralWithSign =
    | CustomMotiontranslatexloopLiteral
    | `-${CustomMotiontranslatexloopLiteral}`
type CustomMotiontranslateyLiteral = `motion-translate-y-${CustomRef4}`
type CustomMotiontranslateyLiteralWithSign =
    | CustomMotiontranslateyLiteral
    | `-${CustomMotiontranslateyLiteral}`
type CustomMotiontranslateyloopLiteral = `motion-translate-y-loop-${CustomRef3}`
type CustomMotiontranslateyloopLiteralWithSign =
    | CustomMotiontranslateyloopLiteral
    | `-${CustomMotiontranslateyloopLiteral}`
type CustomMotionblurLiteral = `motion-blur-${CustomRef5}`
type CustomMotionblurLiteralWithSign =
    | CustomMotionblurLiteral
    | `-${CustomMotionblurLiteral}`
type CustomMotiondelayLiteral = `motion-delay-${CustomRef6}`
type CustomMotiondelayLiteralWithSign =
    | CustomMotiondelayLiteral
    | `-${CustomMotiondelayLiteral}`
type CustomMotiondurationLiteral = `motion-duration-${CustomRef6}`
type CustomMotiondurationLiteralWithSign =
    | CustomMotiondurationLiteral
    | `-${CustomMotiondurationLiteral}`
type CustomMotioneaseinLiteral = `motion-ease-in-${CustomRef7}`
type CustomMotioneaseinLiteralWithSign =
    | CustomMotioneaseinLiteral
    | `-${CustomMotioneaseinLiteral}`
type CustomMotioneaseoutLiteral = `motion-ease-out-${CustomRef8}`
type CustomMotioneaseoutLiteralWithSign =
    | CustomMotioneaseoutLiteral
    | `-${CustomMotioneaseoutLiteral}`
type CustomMotioneasespringLiteral = `motion-ease-spring-${CustomRef9}`
type CustomMotioneasespringLiteralWithSign =
    | CustomMotioneasespringLiteral
    | `-${CustomMotioneasespringLiteral}`
type CustomMotionloopLiteral = `motion-loop-${CustomRef10}`
type CustomMotionloopLiteralWithSign =
    | CustomMotionloopLiteral
    | `-${CustomMotionloopLiteral}`
type CustomMotionopacityLiteral = `motion-opacity-${CustomRef11}`
type CustomMotionopacityLiteralWithSign =
    | CustomMotionopacityLiteral
    | `-${CustomMotionopacityLiteral}`
type CustomMotionpresetLiteral = `motion-preset-${CustomRef12}`
type CustomMotionpresetLiteralWithSign =
    | CustomMotionpresetLiteral
    | `-${CustomMotionpresetLiteral}`
type CustomMotionpresetflomojiLiteral = `motion-preset-flomoji-${CustomRef13}`
type CustomMotionpresetflomojiLiteralWithSign =
    | CustomMotionpresetflomojiLiteral
    | `-${CustomMotionpresetflomojiLiteral}`
type CustomMotionscalexLiteral = `motion-scale-x-${CustomRef14}`
type CustomMotionscalexLiteralWithSign =
    | CustomMotionscalexLiteral
    | `-${CustomMotionscalexLiteral}`
type CustomMotionscaleyLiteral = `motion-scale-y-${CustomRef14}`
type CustomMotionscaleyLiteralWithSign =
    | CustomMotionscaleyLiteral
    | `-${CustomMotionscaleyLiteral}`
type CustomMotiontextLiteral = `motion-text-${CustomRef15}`
type CustomMotiontextLiteralWithSign =
    | CustomMotiontextLiteral
    | `-${CustomMotiontextLiteral}`
type CustomProseLiteral = `prose-${CustomRef16}`
type CustomProseLiteralWithSign = CustomProseLiteral | `-${CustomProseLiteral}`
type CustomScrollbarcornerLiteral = `scrollbar-corner-${CustomRef17}`
type CustomScrollbarcornerLiteralWithSign =
    | CustomScrollbarcornerLiteral
    | `-${CustomScrollbarcornerLiteral}`
type CustomScrollbarthumbLiteral = `scrollbar-thumb-${CustomRef17}`
type CustomScrollbarthumbLiteralWithSign =
    | CustomScrollbarthumbLiteral
    | `-${CustomScrollbarthumbLiteral}`
type CustomScrollbartrackLiteral = `scrollbar-track-${CustomRef17}`
type CustomScrollbartrackLiteralWithSign =
    | CustomScrollbartrackLiteral
    | `-${CustomScrollbartrackLiteral}`
type CustomMotioneaseLiteral = `motion-ease-${CustomRef18}`
type CustomMotioneaseLiteralWithSign =
    | CustomMotioneaseLiteral
    | `-${CustomMotioneaseLiteral}`
type CustomMotionscaleLiteral = `motion-scale-${CustomRef14}`
type CustomMotionscaleLiteralWithSign =
    | CustomMotionscaleLiteral
    | `-${CustomMotionscaleLiteral}`
type CustomMotionLiteral = `motion-${CustomRef19}`
type CustomMotionLiteralWithSign =
    | CustomMotionLiteral
    | `-${CustomMotionLiteral}`
type CustomScrollbarLiteral = `scrollbar-${CustomRef20}`
type CustomScrollbarLiteralWithSign =
    | CustomScrollbarLiteral
    | `-${CustomScrollbarLiteral}`
type CustomValue =
    | "prose"
    | "scrollbar"
    | CustomMotionrotateLiteralWithSign
    | CustomMotiontranslatexLiteralWithSign
    | CustomMotiontranslatexloopLiteralWithSign
    | CustomMotiontranslateyLiteralWithSign
    | CustomMotiontranslateyloopLiteralWithSign
    | CustomMotionblurLiteralWithSign
    | CustomMotiondelayLiteralWithSign
    | CustomMotiondurationLiteralWithSign
    | CustomMotioneaseinLiteralWithSign
    | CustomMotioneaseoutLiteralWithSign
    | CustomMotioneasespringLiteralWithSign
    | CustomMotionloopLiteralWithSign
    | CustomMotionopacityLiteralWithSign
    | CustomMotionpresetLiteralWithSign
    | CustomMotionpresetflomojiLiteralWithSign
    | CustomMotionscalexLiteralWithSign
    | CustomMotionscaleyLiteralWithSign
    | CustomMotiontextLiteralWithSign
    | CustomProseLiteralWithSign
    | CustomScrollbarcornerLiteralWithSign
    | CustomScrollbarthumbLiteralWithSign
    | CustomScrollbartrackLiteralWithSign
    | CustomMotioneaseLiteralWithSign
    | CustomMotionscaleLiteralWithSign
    | CustomMotionLiteralWithSign
    | CustomScrollbarLiteralWithSign

...
## 1. Unable to type check

The biggest problem of `tailwind` is **type safety**.

Although `Tailwindcss Intellisense` plugin solve this problem with **autocompletion magic🔮**, **you can't never typecheck classname in _runtime_ or _build_ process**.
...
## 2. Difficult to reuse className
...
## 3. className too long horizontally
